  ...
  return (
    ...
    >
      ...
      <span className="ml-1 text-text-tertiary transition-colors duration-fast group-hover:text-text-secondary">
        {copied ? (
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="text-quantum">
