...
describe('CatalogPageClient — Page Header', () => {
  it('renders the "Algorithm Library" heading', () => {
    ...
    expect(
      screen.getByRole('heading', { name: 'Algorithm Library' })
    ).toBeInTheDocument();
  });
  ...
  it('renders the page description', () => {
    ...
    expect(
      screen.getByText(/interactive, step-by-step visualizations/i)
    ).toBeInTheDocument();
  });
});
...
describe('CatalogPageClient — Category Filter Bar', () => {
  ...
  it('renders category tabs', () => {
    ...
    expect(
      screen.getByRole('tab', { name: /Classical/ })
    ).toBeInTheDocument();
    expect(
      screen.getByRole('tab', { name: /Deep Learning/ })
    ).toBeInTheDocument();
  });
...
describe('CatalogPageClient — Search', () => {
  ...
  it('search input has correct placeholder', () => {
    ...
    expect(
      screen.getByPlaceholderText('Search algorithms...')
    ).toBeInTheDocument();
  });
});
...
describe('CatalogPageClient — Algorithm Cards', () => {
  ...
  it('renders the algorithm grid with list role', () => {
    ...
    expect(
      screen.getByRole('list', { name: 'Algorithm cards' })
    ).toBeInTheDocument();
  });
